...
from prefix_tuning2 import PrefixTuning
...
class PrefixTransformer(pl.LightningModule):
    def __init__(
        ...
        **config_kwargs
        ...
        self.config.preseqlen = self.hparams.preseqlen + self.hparams.cefr_length
        ...
        config_prefix.m_prefix_mid_dim = self.hparams.cefr_mid_dim
        config_prefix.cefr_length = self.hparams.cefr_length
        config_prefix.CEFR_single_reparam = self.hparams.CEFR_single_reparam
        config_prefix.same_initialization = self.hparams.same_CEFR_intialization
