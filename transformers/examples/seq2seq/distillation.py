...
class BartSummarizationDistiller(SummarizationModule):
    ...
    def __init__(self, hparams):
        ...
        use_task_specific_params(self.teacher, "GEC")
    ...
    def _step(self, batch):
        ...
        # Same cross entropy vs. label smoothing logic as finetune_summarization.py
...
class T5SummarizationDistiller(BartSummarizationDistiller):
    def pre_init(self, hparams):
        ...
        if task_specific_params is not None:
            student.config.update(task_specific_params.get("GEC", {}))  # TODO: dont hardcode
        save_dir = self.output_dir.joinpath("student")
