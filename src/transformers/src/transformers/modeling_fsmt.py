...
FSMT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            Provide for translation and GEC training. By default, the model will create this tensor by
...
@add_start_docstrings(
    "The FSMT Model with a language modeling head. Can be used for GEC.", FSMT_START_DOCSTRING
)
