...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> # see ``examples/GEC/bart/run_eval.py`` for a longer example
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            Provide for translation and GEC training. By default, the model will create this tensor by shifting the input_ids right, following the paper.
...
@add_start_docstrings(
    "The BART Model with a language modeling head. Can be used for GEC.", BART_START_DOCSTRING
)
