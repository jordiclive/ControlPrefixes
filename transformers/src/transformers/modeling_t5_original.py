...
class T5LayerSelfAttention(nn.Module):
    ...
    def forward(
        ...
        attention_output = self.SelfAttention(
            norm_x, # E0: torch.Size([8, 512, 768])
            mask=attention_mask, #E0 torch.Size([8, 1, 1, 512]) is padding mask for E
...
class T5Block(nn.Module):
    ...
    def forward(
        ...
        self_attention_outputs = self.layer[0](
            ...
            attention_mask=attention_mask, # E0 torch.Size([8, 1, 1, 512])
            position_bias=position_bias, # E0 None
            head_mask=head_mask,# E0 None
            past_key_value=self_attn_past_key_value, # E0 None
            use_cache=use_cache,# E0 None
    ...
    def forward(
        ...
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            ...
            layer_outputs = layer_module(
                hidden_states,  # E0: 8 x 512 x 768
                attention_mask=extended_attention_mask, # E:  8 x 1 x 1 x 512
                position_bias=position_bias, # E0: None
                encoder_hidden_states=encoder_hidden_states, # E0: None
                encoder_attention_mask=encoder_extended_attention_mask, # E0: None
                encoder_decoder_position_bias=encoder_decoder_position_bias,# E0: None
                head_mask=head_mask[i], #E0: None
                past_key_value=past_key_value,#E0: None
                use_cache=use_cache,# E0: False
                output_attentions=output_attentions, # E0: False
            )
...
if __name__ == '__main__':
    import sys
    sys.path.append('/Users/jordi/Desktop/Master/prefix_tuning/transformers/summarization')
    #
    # print(Path(__file__)).  #text_recognizer/tests/test_character_predictor.py
    #
    # print(Path(__file__).parents[0]) #text_recognizer/tests
    #
    #
    ...
    batch = pickle_load('/Users/jordi/Desktop/Master/prefix_tuning/transformers/summarization/b1_t5.pkl')
    ...
    # # pkvs = model.model.get_prompt(bsz=8)
    # kwargs = {'input_ids':src_ids,'attention_mask' : src_mask,'decoder_input_ids': decoder_input_ids, 'use_cache' : False, 'use_prefix': True}
    # out = model(src_ids, attention_mask = src_mask, decoder_input_ids = decoder_input_ids, use_cache = False,
    #      use_prefix = True)
    kwargs = pickle_load('/Users/jordi/Desktop/Master/prefix_tuning/transformers/summarization/b1_t52.pkl')

    config = AutoConfig.from_pretrained('t5-base', cache_dir = '/Users/jordi/Desktop/data/X_SUM/cache_dir')
    ...
    MODEL = T5ForConditionalGeneration.from_pretrained(
        ...
        from_tf = False,
        config = config,
        cache_dir = '/Users/jordi/Desktop/data/X_SUM/cache_dir',
    )
    kwargs.pop('use_prefix')
