...
from utils_conditional3 import (
    ROUGE_KEYS,
...
from CEFR2 import (
    CustomBatchSampler,
    CustomBatchSampler_2,
    CustomBatchSampler_val,
    freeze_prefix1
)
#
import os
...
from lightning_base2 import add_generic_args, generic_train, PrefixTransformer  # noqa
...
class PrefixSummarizationModule(PrefixTransformer):
    ...
    def __init__(self, hparams, **kwargs):
        ...
        print('BEEFORE', self.seq2seq_model.shared.weight.shape)
        if self.hparams.new_tokens:
            self.seq2seq_model.resize_token_embeddings(len(self.tokenizer))
            print('AFTER', self.seq2seq_model.shared.weight.shape)
    ...
    def _step(self, batch: dict) -> Tuple:
        ...
        outputs = self(src_ids, attention_mask=src_mask, decoder_input_ids=decoder_input_ids, use_cache=False,
                       use_prefix=True,conditional_info={'cats':batch['cats'],'sources':batch['sources']})
    ...
    def training_step(self, batch, batch_idx) -> Dict:
        ...
        if batch_idx == 0:
            ...
            # print('Original',self.seq2seq_model.model.encoder.embed_tokens.weight[5:8])
            print('Trainable', self.seq2seq_model.encoder.embed_tokens.trainable_weight)
            # print("ES",self.model.es.trainable_weight)
    ...
    def validation_step(self, batch, batch_idx) -> Dict:
        ...
        if self.hparams.hf_checkpoint:
            ...
            print('Prefix_stored_weight', self.model.es.trainable_weight)
    ...
    def validation_epoch_end(self, outputs, prefix="val") -> Dict:
        ...
        if prefix == "val":
            ...
            output_no_process = os.path.join(self.hparams.output_dir, val_outputs_folder, "output_no_proceess_" +
                                                    str(self.step_count) + ".txt")
    ...
    def test_step(self, batch, batch_idx, dataloader_idx):
        if batch_idx==0:
            print('Trainable', self.seq2seq_model.shared.trainable_weight)
    ...
    def test_epoch_end(self, outputs_all_testsets):
        ...
        for outputs in outputs_all_testsets:
            ...
            output_no_process = os.path.join(self.hparams.output_dir, val_outputs_folder,
...
def main(args, model=None):
    ...
    # model.seq2seq_model.model.encoder.embed_tokens.trainable_weight = model.model.es.trainable_weight
    ...
    # pickle_save(args,'/Users/jordi/Desktop/Master/prefix_tuning/transformers/GEC/args_m_prefix_T5.pkl')
    # pickle_save(batch,'/Users/jordi/Desktop/Master/prefix_tuning/transformers/GEC/batch_m_prefix_T5.pkl')

    # batch = pickle_load( '/Users/jordi/Desktop/Master/prefix_tuning/transformers/GEC/b1_m_prefix.pkl')
